        ...
        <div className="order-2 lg:order-1">
          <div className="mb-6 sm:mb-8">
            ...
            <p className="text-gray-600 text-sm xs:text-base sm:text-lg">
              Our team is here to help you find the perfect cook or answer any questions.
            </p>
          </div>
          ...
          <form className="space-y-4 sm:space-y-6">
            ...
            <div>
              ...
              <textarea 
                ...
                placeholder="Tell us about your cooking needs or questions..."
                required
              ></textarea>
            </div>
