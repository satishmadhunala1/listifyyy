// src/components/Housekeeper/HousekeeperHero.jsx
import { ArrowRight, ChevronRight } from "lucide-react";
import { RainbowButton } from "../../ui/rainbow-button";

const HousekeeperHero = () => {
  const heroData = {
    title: "Find Professional Housekeepers",
    subtitle: "Reliable, thorough cleaning and household management",
    description: "Connect with verified housekeepers for regular cleaning, deep cleaning, or specialized household services. All professionals are background-checked and reviewed.",
  };
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8">
        <div className="text-center text-white py-8 sm:py-12 lg:py-16 px-2">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mb-6 sm:mb-8">
            <RainbowButton className="w-full sm:w-auto bg-purple-600 hover:bg-purple-700 px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base rounded-lg sm:rounded-xl">
              Hire a Housekeeper
            </RainbowButton>
          ...
          <button 
            ...
            aria-label="Find housekeepers near me"
          >
            <span>Find Housekeepers</span>
...
export default HousekeeperHero;