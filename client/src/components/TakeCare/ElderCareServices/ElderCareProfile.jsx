...
export default function ElderCareProfile() {
  const steps = [
    {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8 sm:mb-10 lg:mb-12 px-2">
          ...
          <p className="text-gray-600 text-sm xs:text-base sm:text-lg">
            Connect with families looking for compassionate senior care.
          </p>
        </div>
        ...
        <div className="text-center">
          <button 
            ...
            aria-label="Create your caregiver profile"
          >
          ...
          <p className="mt-4 sm:mt-6 text-gray-500 text-xs xs:text-sm">
            Join thousands of care professionals already connected with families
          </p>
        </div>
      </div>
    </div>
