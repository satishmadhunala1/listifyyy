...
const ElderCareAbout = () => {
  const features = [
    {
      id: '01',
      icon: <Award className="w-8 h-8 xs:w-10 xs:h-10 sm:w-10 sm:h-10" />,
      title: 'We are the experts',
      description: 'Thousands of families already love, trust, and rely on Sulekha for professional elder care services.',
    },
    {
      id: '02',
      icon: <Shuffle className="w-8 h-8 xs:w-10 xs:h-10 sm:w-10 sm:h-10" />,
      title: 'Flexible Options',
      description: 'Choose from companionship, personal care, medication management, mobility assistance, and specialized dementia care.',
    },
    {
      id: '03',
      icon: <BadgeCheck className="w-8 h-8 xs:w-10 xs:h-10 sm:w-10 sm:h-10" />,
      title: 'Quality Assurance',
      description: '97% satisfaction rate from families, ensuring you receive compassionate and professional senior care.',
    },
    {
      id: '04',
      icon: <Users className="w-8 h-8 xs:w-10 xs:h-10 sm:w-10 sm:h-10" />,
      title: 'Experienced Caregivers',
      description: 'With thousands of successful engagements, our senior care professionals bring proven expertise and compassion.',
    },
    {
      id: '05',
      icon: <Clock className="w-8 h-8 xs:w-10 xs:h-10 sm:w-10 sm:h-10" />,
      title: 'Quick Matches',
      description: 'Find the right caregiver within hours, perfect for immediate needs or regular care schedules.',
    },
    {
      id: '06',
      icon: <HandHeart className="w-8 h-8 xs:w-10 xs:h-10 sm:w-10 sm:h-10" />,
      title: 'Peace of Mind',
      description: 'Ensure your loved ones receive dignified care knowing their needs are in professional and caring hands.',
    }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8 sm:mb-10 lg:mb-16 px-2">
          ...
          <p className="text-gray-600 text-sm xs:text-base sm:text-lg lg:text-lg">
            Why Find <span className='text-[#27BB97] font-medium'>Elder Care with Listify</span>?
          </p>
        </div>
