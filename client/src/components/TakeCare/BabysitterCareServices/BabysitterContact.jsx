// BabysitterContact.jsx
const BabysitterContact = () => (
        ...
        <div className="order-2 lg:order-1">
          <div className="mb-6 sm:mb-8">
            ...
            <p className="text-gray-600 text-sm xs:text-base sm:text-lg">
              Our team is here to help you find the perfect babysitter or answer any questions.
            </p>
          </div>
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="flex items-center gap-3 xs:gap-4 p-3 xs:p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-200">
              ...
              <div className="min-w-0">
                ...
                <a 
                  href="mailto:support@babysitters.com" 
                  className="text-[#27BB97] hover:text-[#1FA987] transition-colors text-sm xs:text-base block truncate"
                >
                  support@babysitters.com
                </a>
          ...
          <form className="space-y-4 sm:space-y-6">
            ...
            <div>
              ...
              <textarea 
                ...
                placeholder="Tell us about your babysitting needs or questions..."
                required
              ></textarea>
            </div>
...
export default BabysitterContact;