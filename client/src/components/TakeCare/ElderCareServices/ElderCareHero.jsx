// src/components/ElderCare/ElderCareHero.jsx
import { ArrowRight, ChevronRight } from "lucide-react";
import { RainbowButton } from "../../ui/rainbow-button";

const ElderCareHero = () => {
  const heroData = {
    title: "Find Compassionate Elder Care",
    subtitle: "Dignified care and companionship for seniors",
    description: "Connect with verified caregivers for in-home care, companionship, and specialized senior support. All caregivers are trained, background-checked, and compassionate.",
  };
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8">
        <div className="text-center text-white py-8 sm:py-12 lg:py-16 px-2">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mb-6 sm:mb-8">
            <RainbowButton className="w-full sm:w-auto bg-teal-600 hover:bg-teal-700 px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base rounded-lg sm:rounded-xl">
              Hire Elder Care
            </RainbowButton>
          ...
          <button 
            ...
            aria-label="Find elder care near me"
          >
