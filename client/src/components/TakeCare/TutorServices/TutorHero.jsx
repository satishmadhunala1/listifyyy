...
const TutorHero = () => {
  const heroData = {
    ...
    subtitle: "Personalized learning for academic success",
    description: "Connect with verified tutors for all subjects, grade levels, and learning styles. All tutors are qualified, background-checked, and reviewed.",
  };
  ...
  return (
    <section className="relative min-h-[60vh] sm:min-h-[70vh] lg:min-h-[80vh] flex items-center justify-center overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url('/tutor-1.jpg')`,
        }}
      />
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8">
        <div className="text-center text-white py-8 sm:py-12 lg:py-16 px-2">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mb-6 sm:mb-8">
            <RainbowButton className="w-full sm:w-auto bg-indigo-600 hover:bg-indigo-700 px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base rounded-lg sm:rounded-xl">
              Hire a Tutor
            </RainbowButton>
          ...
          <button 
            ...
            aria-label="Find tutors near me"
          >
