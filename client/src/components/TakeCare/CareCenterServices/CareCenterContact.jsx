      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10 xl:gap-12">
        ...
        <div className="order-2 lg:order-1">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="flex items-center gap-3 xs:gap-4 p-3 xs:p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-200">
              ...
              <div className="min-w-0">
                <p className="font-semibold text-gray-900 text-sm xs:text-base">General Inquiries</p>
                <a 
            ...
            <div className="flex items-center gap-3 xs:gap-4 p-3 xs:p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-200">
              ...
              <div className="min-w-0">
                <p className="font-semibold text-gray-900 text-sm xs:text-base">Facility Listings</p>
                <a 
                  href="mailto:listings@carecenters.com" 
                  className="text-[#27BB97] hover:text-[#1FA987] transition-colors text-sm xs:text-base block truncate"
                >
                  listings@carecenters.com
                </a>
                <p className="text-gray-500 text-xs xs:text-sm mt-0.5">For care center providers</p>
              </div>
            </div>
            
            {/* Care Advisors */}
            <div className="flex items-center gap-3 xs:gap-4 p-3 xs:p-4 bg-[#27BB97]/5 rounded-xl hover:bg-[#27BB97]/10 transition-colors duration-200">
              <div className="w-10 h-10 xs:w-12 xs:h-12 bg-[#27BB97]/20 rounded-full flex items-center justify-center flex-shrink-0">
                <span className="text-xl xs:text-2xl">👨‍⚕️</span>
              </div>
              <div>
                <p className="font-semibold text-gray-900 text-sm xs:text-base">Care Advisors</p>
                <a 
                  href="tel:+15551234568" 
                  className="text-[#27BB97] hover:text-[#1FA987] transition-colors text-sm xs:text-base"
                >
                  +1 (555) CARE-ADV
                </a>
                <p className="text-gray-500 text-xs xs:text-sm mt-0.5">Free consultation service</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 sm:mt-8 p-3 xs:p-4 bg-gradient-to-r from-[#27BB97]/5 to-[#1FA987]/5 rounded-xl">
            <p className="text-gray-600 text-xs xs:text-sm">
              <span className="font-semibold text-[#27BB97]">Quick Tip:</span> For faster service, have your location, budget, and care needs ready when you contact us.
            </p>
          </div>
        </div>
        ...
        <div className="order-1 lg:order-2 bg-gray-50 rounded-xl sm:rounded-2xl p-4 xs:p-5 sm:p-6 lg:p-8">
          ...
          <form className="space-y-4 sm:space-y-6">
            ...
            {/* Inquiry Type */}
            <div>
              <label htmlFor="inquiry-type" className="block text-gray-700 mb-1.5 xs:mb-2 text-sm xs:text-base">
                Inquiry Type
              </label>
              <select 
                id="inquiry-type"
              ...
              >
                ...
                <option value="find-center">Find a Care Center</option>
                <option value="list-center">List a Care Center</option>
            ...
            <div>
              ...
              <textarea 
                ...
                placeholder="Tell us about your care center needs or questions..."
                required
              ></textarea>
            </div>
...
export default CareCenterContact;