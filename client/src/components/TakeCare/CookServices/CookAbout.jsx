  ...
  const features = [
    {
      ...
      description: 'Thousands of families already love, trust, and rely on Sulekha for professional cooking services.',
    },
    {
      id: '02',
      icon: <Shuffle className="w-8 h-8 xs:w-10 xs:h-10 sm:w-10 sm:h-10" />,
      title: 'Flexible Options',
      description: 'Choose from daily meal prep, party catering, specialized diets, and personal chef services.',
    },
    {
      id: '03',
      icon: <BadgeCheck className="w-8 h-8 xs:w-10 xs:h-10 sm:w-10 sm:h-10" />,
      title: 'Quality Assurance',
      description: '97% satisfaction rate from clients, ensuring you receive professional and delicious culinary service.',
    },
    {
      id: '04',
      icon: <Users className="w-8 h-8 xs:w-10 xs:h-10 sm:w-10 sm:h-10" />,
      title: 'Experienced Cooks & Chefs',
      description: 'With thousands of successful engagements, our culinary professionals bring proven expertise.',
    },
    {
      id: '05',
      icon: <Clock className="w-8 h-8 xs:w-10 xs:h-10 sm:w-10 sm:h-10" />,
      title: 'Quick Matches',
      description: 'Find the right cook within hours, perfect for last-minute dinner parties or event planning.',
    },
    {
      id: '06',
      icon: <HandHeart className="w-8 h-8 xs:w-10 xs:h-10 sm:w-10 sm:h-10" />,
      title: 'Peace of Mind',
      description: 'Enjoy delicious, professionally prepared meals knowing your culinary needs are in expert hands.',
    }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8 sm:mb-10 lg:mb-16 px-2">
          ...
          <p className="text-gray-600 text-sm xs:text-base sm:text-lg lg:text-lg">
            Why Find a <span className='text-[#27BB97] font-medium'>Cook with Listify</span>?
          </p>
        </div>
                  ...
                  <div className="flex items-center justify-center my-6 xl:my-0">
                    <div className="relative">
                      ...
                      <div className="relative rounded-full overflow-hidden w-64 h-64 lg:w-72 lg:h-72 xl:w-80 xl:h-80 border-8 border-white shadow-xl">
                        <img
                          src="/cook-2.jpg"
                          alt="Professional cook in kitchen"
