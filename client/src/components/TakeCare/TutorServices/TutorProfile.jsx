      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8 sm:mb-10 lg:mb-12 px-2">
          ...
          <p className="text-gray-600 text-sm xs:text-base sm:text-lg">
            Connect with students looking for professional academic support.
          </p>
        </div>
        ...
        <div className="text-center">
          <button 
            ...
            aria-label="Create your tutor profile"
          >
          ...
          <p className="mt-4 sm:mt-6 text-gray-500 text-xs xs:text-sm">
            Join thousands of teaching professionals already connected with students
          </p>
        </div>
      </div>
    </div>
